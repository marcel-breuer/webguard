...
return [
    ...
    'monitorings' => [
        ...
        'Add your website' => 'Website hinzufügen',
        'Add website' => 'Website hinzufügen',
        'No websites yet' => 'Noch keine Websites',
        'Add your website and WebGuard will check it automatically.' => 'Fügen Sie Ihre Website hinzu. WebGuard prüft ihre Erreichbarkeit automatisch.',
        'Website URL' => 'Website-URL',
        'Enter a website address to start a standard availability check.' => 'Geben Sie eine Website-Adresse ein, um eine standardmäßige Erreichbarkeitsprüfung zu starten.',
        'WebGuard will use the standard HTTP availability check. Your first results appear on the website details page.' => 'WebGuard prüft die Erreichbarkeit Ihrer Website per HTTP. Erste Ergebnisse finden Sie in den Website-Details.',
        ...
        'Monitoring is active' => 'Überwachung ist aktiv',
        'WebGuard is monitoring this website.' => 'WebGuard überwacht diese Website.',
        'Monitoring is paused. Start it from the website details page to receive checks.' => 'Die Überwachung ist pausiert. Aktivieren Sie sie in den Website-Details, um Prüfungen zu erhalten.',
        'View website details' => 'Website-Details anzeigen',
    ...
    'dashboard' => [
        'Your websites' => 'Ihre Websites',
        'Check which websites are working, which need attention, and when they were last checked.' => 'Sehen Sie, welche Websites erreichbar sind, wo es Probleme gibt und wann sie zuletzt geprüft wurden.',
        'Website health' => 'Website-Status',
        'Some websites are down' => 'Einige Websites sind ausgefallen',
        'Some websites need a recent check' => 'Einige Websites benötigen eine aktuelle Prüfung',
        'All checked websites are working' => 'Alle geprüften Websites sind erreichbar',
        'All your websites are under maintenance' => 'Alle Ihre Websites werden gewartet',
        'All your websites are paused' => 'Alle Ihre Websites sind pausiert',
        'Action needed' => 'Handlungsbedarf',
        'Needs a check' => 'Prüfung erforderlich',
        'Working' => 'Erreichbar',
        'websites' => 'Websites',
        'Websites with an issue, or notification delivery problems.' => 'Websites mit Problemen oder fehlgeschlagenen Benachrichtigungen.',
        'No websites need attention.' => 'Bei keiner Website ist ein Eingreifen nötig.',
        'Website is down' => 'Website ist ausgefallen',
        'Notification delivery issue' => 'Problem bei der Benachrichtigung',
        'No recent check' => 'Keine aktuelle Prüfung',
        'notification deliveries' => 'Benachrichtigungen',
        'Current status and last check for each website.' => 'Aktueller Status und letzte Prüfung jeder Website.',
        'Search websites' => 'Websites suchen',
        'Search by name or address' => 'Nach Name oder Adresse suchen',
        'Website filters' => 'Website-Filter',
        'No websites match your search or filters.' => 'Keine Website entspricht der Suche oder den Filtern.',
        'Not checked yet' => 'Noch nicht geprüft',
        'Recent incidents for your websites.' => 'Aktuelle Vorfälle bei Ihren Websites.',
    ],
    'dynamic' => [
        'Current status:' => 'Aktueller Status:',
        'Overall service status:' => 'Gesamter Dienststatus:',
